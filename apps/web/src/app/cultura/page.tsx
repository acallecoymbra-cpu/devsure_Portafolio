...
import { CompanyCarousel, CultureCarousel } from '@/features/culture/components/culture-carousels';
      ...
      >
        <div className="shell">
          <div className={styles.sectionHeading}>
            ...
            <p>
              La cultura no es una frase en la pared. Es cómo escuchamos, decidimos, verificamos y
              avanzamos juntos.
            </p>
          </div>
          <CultureCarousel stories={cultureStories} />
        </div>
      </section>
